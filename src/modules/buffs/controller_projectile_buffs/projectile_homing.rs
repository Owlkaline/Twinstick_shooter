...
#[derive(Clone)]
pub struct ControllerHomingBuff {
  data: BuffData,
}

impl ControllerHomingBuff {
  pub fn new() -> ControllerHomingBuff {
    ControllerHomingBuff {
      data: BuffData::new(24, 5, LootRarity::Rare),
    }
  }
}

impl Buff for ControllerHomingBuff {
  ...
  fn set_bullet_controller(&self) -> Option<Box<dyn GenericBulletController>> {
    // should use 
    Some(Box::new(HomingBulletController::new()))
  }
